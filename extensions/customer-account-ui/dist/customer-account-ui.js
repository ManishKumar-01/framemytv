...
${errorInfo.componentStack}`);
  ...
  function MenuActionExtension() {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { to: "extension:/return?order-id=" + extractOrderId(orderId), children: i18n.translate("menuItem.button") });
  }
  ...
  function FullPageExtension() {
    ...
    function getOrderIdFromUrl() {
      ...
      const orderId2 = url.searchParams.get("order-id");
      return orderId2;
    }
    const orderId = getOrderIdFromUrl();
    console.log(orderId);
    const [value, setValue] = (0, import_react19.useState)(1);
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Page2, { title: i18n.translate("fullPageTitle"), children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { children: "Need to Return Your Frame? We're sorry to hear that, but we understand sometimes it's necessary to part with your masterpiece. Though, there may be a way to solve your problem. Have you checked out our helpful troubleshooting page? If you'd like to do so, please follow this link. We try to make the returns process as easy and painless as possible. Please complete the following form and we will be in touch within 1-2 business days with further instructions." }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { children: "Returns are accepted within 30 days from the date of delivery." }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Form2, { onSubmit: () => console.log("onSubmit event"), children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Grid2, { columns: ["50%", "50%"], spacing: "base", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TextField2, { label: "First name", required: "true" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TextField2, { label: "Last name", required: "true" }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BlockSpacer2, { spacing: "base" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Grid2, { columns: ["33%", "33%", "33%"], spacing: "base", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TextField2, { label: "Order Number", required: "1" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TextField2, { label: "Email", required: "true" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TextField2, { label: "Phone Number", required: "true" }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BlockSpacer2, { spacing: "base" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(GridItem2, { columnSpan: 2, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          Select2,
          {
            label: "Request Type",
            value,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BlockSpacer2, { spacing: "base" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(GridItem2, { columnSpan: 2, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TextField2, { label: "Additional Notes", multiline: "true" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BlockSpacer2, { spacing: "base" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Button2, { accessibilityRole: "submit", children: "Submit" })
      ] })
    ] });
  }
})();
